...
- [`is_open()`](https://huishenlab.github.io/compartmap/dev/reference/is_open.md)
  [`is_closed()`](https://huishenlab.github.io/compartmap/dev/reference/is_open.md)
...
- [`differentiate()`](https://huishenlab.github.io/compartmap/dev/reference/differentiate.md)
  : Compute the direction of change of singular vectors in the
